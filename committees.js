...
Commitee.prototype.toString = function() {
	return this.abreviation + " (" + this.name + ")";
}

committees = [
new Commitee(0, "SPAG", "Sesión Plenaria de la Asamblea General"),
new Commitee(0, "DISEC", "First Commitee Disarment and International Security"),
new Commitee(0, "TERCERA", "Tercera Comisión en Asuntos Sociales, Culturales y Humanitarios"),
new Commitee(0, "UN WOMEN", "United Nations Entity for Gender Equality and the Empowerment of Women"),
new Commitee(0, "ACNUR", "Alto Comisionado de las Naciones Unidas para los Refugiados"),
new Commitee(0, "PNUFID", "Programa de las Naciones Unidas para la Fiscalización Internacional de Drogas"),
new Commitee(1, "UNFPA", "United Nations Population Fund"),
new Commitee(1, "UNICEF", "Fondo de las Naciones Unidas para la Infancia"),
new Commitee(1, "CSTSD", "Commission de la Science et de la Technologie au Service du Dévelopment"),
...
committees.forEach(commitee => {
    if(commitee.type == "General Assembly") { general_assembly.push(commitee); }
    if(commitee.type == "Special Committees") { special_committees.push(commitee); }
    if(commitee.type == "Crisis Committees") { crisis_committees.push(commitee); }
});
